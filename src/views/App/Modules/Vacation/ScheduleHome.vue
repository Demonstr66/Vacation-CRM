      ...
      <template v-slot:item.action="{item}">
        <RowActions>
          ...
          <icon-btn-with-tip
              ...
              tag="a"
              :to="{name: 'ScheduleStatistic', params: {id: item.id}}"
          >
            Статистика
          </icon-btn-with-tip>
          <icon-btn-with-tip
              ...
              icon="mdi-eye"
              tag="a"
              :to="{name: 'ScheduleViewerList', params: {id: item.id}}"
          >
            Просмотр
          </icon-btn-with-tip>
          <icon-btn-with-tip
              ...
              tag="a"
              :to="{name: 'ScheduleViewerTimeline', params: {id: item.id}}"
          >
            Таймлайн
          </icon-btn-with-tip>
          <icon-btn-with-tip
