...
import InputNumWithBtns from "@/components/VacationStatistic/input-num-with-btns";
...
export default {
  ...
  components: {
    ...
    IconBtnWithTip,
    BtnOpenSidebar,
    AppGroupToolbar, GroupTools, AppUserFilter, InputNumWithBtns, AppBlockWithRightNavbar, AppBaseSheet
  },
